...
<!-- begin panel -->
<form action="{{ isset($data) ? route('master-data.status-keluarga.update', $data->id) : route('master-data.status-keluarga.store') }}" id="form" name="form" method="POST" data-parsley-validate="true">
  @csrf
  @if(isset($data))
  {{ method_field('PUT') }}
  @endif
