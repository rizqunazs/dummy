...
<ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item "><a href="javascript:history.back(-1);" class="btn btn-sm btn-primary m-b-10 text-white"><i class="fa fa-list "></i> &nbsp; List Data</a></li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
            ...
            <div class="panel-body">
                <form action={{ route('skck.store') }} method="post">
                            ...
                            <div class="row row-space-10">
                                <div class="col-md-2">
                                    <div class="input-group">
                                        <div class="input-group">
                                            <input type="text" name="no_skck[]" class="form-control m-b-5" placeholder="SKCK" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="input-group">
                                        <div class="input-group">
                                            <input type="text" name="no_skck[]" class="form-control m-b-5" placeholder="YANMAS" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="input-group">
                                        <input class="form-control" type="number" name="no_skck[]" id="" placeholder="Nomor">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="no_skck[]" id="" placeholder="Satuan">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row m-b-15">
                                ...
                                <div class="col-md-9">
                                    <select class="select2 form-control input-sm" name="keperluan" id="keperluan" required="" data-select2-id="select2-data-keperluan" tabindex="-1" aria-hidden="true" aria-required="true">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row m-b-15">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" name="keterangan_tambahan" id="keterangan_tambahan" cols="30" placeholder="Keterangan Tambahan"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row m-b-15">
                                ...
                                <div class="col-md-9">
                                    <input type="number" name="nik_ektp" class="form-control m-b-5" placeholder="NIK" required />
                                </div>
                            </div>
                            <div class="form-group row m-b-15">
                    ...
                    <div class="row form-group ">
                        <label class="col-md-3 col-form-label">Tempat/Tanggal Lahir<span class="text-danger">&nbsp;*</span> <br>
                        ...
                        <div class="col-md-9">
                            <div class="row row-space-10">
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <div class="input-group">
                                            <input type="text" class="form-control m-b-5" name="tempat_lahir" placeholder="Tempat Lahir" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <label class="radio-inline">
                                                <input required="" type="radio" name="gender" id="gender1" value="laki-laki" checked="checked" aria-required="true" class="valid">
                                                <span> Laki-laki</span>
                                            </label>
                                            <label class="radio-inline">
                                                <input required="" type="radio" name="gender" id="gender2" value="perempuan" aria-required="true" class="valid">
                                                <span>Perempuan</span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <label class="radio-inline">
                                                <input required="" type="radio" name="status_kawin" class="statusperkawinan valid" value="kawin" aria-required="true"><span lang="id"> KAWIN</span>
                                            </label>
                                            <label class="radio-inline">
                                                <input required="" type="radio" name="status_kawin" class="statusperkawinan valid" value="belum kawin" checked="checked" aria-required="true"><span lang="id"> BELUM
                                                    KAWIN</span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <label class="radio-inline">
                                                <input required="" type="radio" name="kebangsaan" id="kebangsaan1" value="WNI" checked="checked" aria-required="true" class="valid"><span lang="id"> WNI</span>
                                            </label>
                                            <label class="radio-inline">
                                                <input required="" type="radio" name="kebangsaan" id="kebangsaan2" value="WNA" aria-required="true" class="valid"><span lang="id">
                                                    WNA</span>
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <div class="row form-group ">
                        <label class="col-md-3 col-form-label">Agama/Pekerjaan/No.Telp<span class="text-danger">&nbsp;*</span><br>
                            <small class="f-s-12 text-grey-darker"><i>Place/Date Of Birth</i></small></label>
                        <div class="col-md-9">
                            <div class="row row-space-10">
                                <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row m-b-15">
                                <label class="col-form-label col-md-3">Alamat Sekarang<span class="text-danger">&nbsp;*</span></label>
                                <div class="col-md-9">
                    ...
                    <div role="family" class="bg-light mb-3 p-5 rounded">
                            ...
                            <div class="col-md-12">
                                <div class="row ">
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group">
                                                <select class="select2 form-control" name="hubungan">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea class="form-control" name="alamat_keluarga" id="alamat_keluarga" cols="30"></textarea>
                            </div>
                        </div>
                        {{-- Alamat Prov kab --}}
                        <div class="row form-group ">
                            <div class="col-md-12">
                                <div class="row row-space-10">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <select class="select2 form-control" name="kabupaten">
                                                <option value="">Pilih Kabupaten</option>
                                                <option value="1">Islam</option>
                                                <option value="2">Hindu</option>
                                            </select>
                                ...
                                <div class="row row-space-10">
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group">
                                                <select class="select2 form-control" name="kecamatan">
                                                    <option value="">Pilih Agama</option>
                                                    <option value="1">Islam</option>
                                                    <option value="2">Hindu</option>
                                                </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <select class="select2 form-control" name="kelurahan">
                                                <option value="">Pilih Agama</option>
                                                <option value="1">Islam</option>
                                                <option value="2">Hindu</option>
                                            </select>
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <button role="btn-remove-family" class="btn btn-warning ml-1" type="button" hidden><i class="fa fa-trash"></i> Hapus Family</button>
                        </div>
                    </div>
                    <!-- Pendidikan -->
                    <br>
                            ...
                            <div class="row row-space-10">
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group">
                                            <select class="select2 form-control" name="tingkat">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="nama_pendidikan" placeholder="Pendidikan">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="input-group d-flex justify-content-around">
                                        <button role="btn-add-riwayat-pendidikan" type="button" class="btn btn-primary"><i class="fa fa-plus"></i></button>
                                        <button role="btn-remove-riwayat-pendidikan" id="" type="button" class="btn btn-warning" hidden><i class="fa fa-trash"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-md-6 vdivide">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="pidana" class="radio-css" value="TIDAK PERNAH" checked="checked"> <span lang="id">TIDAK
                                                    PERNAH</span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-sm" name="perkara" id="isperkarapidana">
                                    </div>
                                </div>
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label lang="id">Bagaimana putusan dan vonis hakim ?</label>
                                        <input type="text" class="form-control input-sm" name="putusan_hakim" id="isvonispidana">
                                    </div>
                                </div>
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label lang="id">Apakah saudara saat ini sedang dalam proses perkara pidana ?
                                            Kasus apa
                                            ?</label>
                                        <input type="text" class="form-control input-sm" name="sedang_perkara" id="isprosespidana">
                                    </div>
                                </div>
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label lang="id">Sampai sejauh mana proses hukumnya ?</label>
                                        <input type="text" class="form-control input-sm" name="proses_hukum" id="ishukumpidana">
                                    </div>
                                </div>
                            </div>
                            <!-- Pelanggaran -->
                            <div class="col-xs-12 col-md-6">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <label class="radio-inline">
                                                <input type="radio" name="pelanggaran" class="ispelanggaran" value="PERNAH"> <span lang="id">PERNAH</span>
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="pelanggaran" class="ispelanggaran" value="TIDAK PERNAH" checked="checked"> <span lang="id">TIDAK
                                                    PERNAH</span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-sm" name="proses_perkara" id="proses_perkara">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="row ">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="rambut" id="rambut" placeholder="Rambut">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <div class="row ">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="tanda_istimewa" class="form-control" placeholder="Tanda Istimewa" />
                                    </div>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="col-md-12">
                            <div class="row ">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="rumus_sidik_jari" class="form-control" placeholder="Rumus Sidik Jari" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for=""><small><b> Rumus Sidik Jari (Kanan)</b></small></label>
                                    <div class="input-group">
                                        <input type="number" name="rumus_sidik_jari" class="form-control" placeholder="Rumus Sidik Jari" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xs-12 col-md-6 ">
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" class="form-control input-sm" name="sponsortelpfaxinfo" id="telpfaxinfo">
                                        </div>
                                        <div class="form-group">
...
<script>
    function handleBtnAddRiwayatPendidikan() {
        "use strict";
        let btn, el, newEl;
        btn = $('button[role="btn-add-riwayat-pendidikan"]');
        btn.off();
        btn.on('click', function(e) {
            ...
            newEl.find('button[role="btn-remove-riwayat-pendidikan"]').removeAttr('hidden');
            newEl.insertAfter(el);

            el.find('button[role="btn-remove-riwayat-pendidikan"]').removeAttr('hidden')
            el.find('button[role="btn-add-riwayat-pendidikan"]').attr('hidden', true);

            initSelect2()
        })
    }

    function handleBtnRemoveRiwayatPendidikan() {
        "use strict";
        let btn, el;

        btn = $('button[role="btn-remove-riwayat-pendidikan"]');
        btn.off();
        btn.on('click', function(e) {
            e.preventDefault();
            el = $(this).closest('.form-group');
            ...
            btn = $('button[role="btn-remove-riwayat-pendidikan"]');
            el = $(btn.last()).closest('.form-group');

            if (btn.length > 1) {
                el.find('button[role="btn-remove-riwayat-pendidikan"]').removeAttr('hidden')
                el.find('button[role="btn-add-riwayat-pendidikan"]').removeAttr('hidden')
            } else {
                el.find('button[role="btn-remove-riwayat-pendidikan"]').attr('hidden', true)
                el.find('button[role="btn-add-riwayat-pendidikan"]').removeAttr('hidden');
            }
    ...
    function handleBtnAddFamily() {
        "use strict";
        let btn, el, newEl;
        btn = $('button[role="btn-add-family"]');
        btn.off();
        btn.on('click', function(e) {
            e.preventDefault();
            el = $(this).closest('div[role="family"]');
            el.find('select.select2').each(function() {
                $(this).select2("destroy");
            });
            ...
            newEl = el.clone(true);
            newEl.find(':input').val('');
            newEl.find('button[role="btn-remove-family"]').removeAttr('hidden');
            newEl.insertAfter(el);

            el.find('button[role="btn-remove-family"]').removeAttr('hidden')
            el.find('button[role="btn-add-family"]').attr('hidden', true);

            initSelect2()
        })
    }

    function handleBtnRemoveFamily() {
        "use strict";
        let btn, el;

        btn = $('button[role="btn-remove-family"]');
        btn.off();
        btn.on('click', function(e) {
            e.preventDefault();
            el = $(this).closest('div[role="family"]');
            ...
            btn = $('button[role="btn-remove-family"]');
            el = $(btn.last()).closest('div[role="family"]');

            if (btn.length > 1) {
                el.find('button[role="btn-remove-family"]').removeAttr('hidden')
                el.find('button[role="btn-add-family"]').removeAttr('hidden')
            } else {
                el.find('button[role="btn-remove-family"]').attr('hidden', true)
                el.find('button[role="btn-add-family"]').removeAttr('hidden');
            }
    ...
    $(function() {
        initSelect2();
        handleBtnAddRiwayatPendidikan();
        handleBtnRemoveRiwayatPendidikan();
        handleBtnAddFamily();
        handleBtnRemoveFamily();
    })
        ...
        if (e.originalEvent) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    $('.upload-image-container').addClass('hasImage');
                    $('.upload-image-container > img').attr("src", reader.result)
                }
            }
