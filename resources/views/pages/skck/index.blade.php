...
<ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item ">SKCK</li>
    <li class="breadcrumb-item "><a href="{{ route('skck.create') }}"
            class="btn btn-sm btn-primary m-b-10 text-white"><i class="fa fa-plus-circle"></i> &nbsp; Tambah Data
            Pemohon</a></li>
    </li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">SKCK <small>Permohonan</small></h1>
<!-- end page-header -->
